...
@interface JJAppDelegate () <GHSidebarSearchViewControllerDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	self.menuController = [[JJMenuViewController alloc] initWithSidebarViewController:self.revealController 
